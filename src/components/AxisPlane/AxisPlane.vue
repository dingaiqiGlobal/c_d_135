  ...
  methods: {
    ...
    updatePointControls() {
      if (this.pointEditCesium) {
        this.pointEditCesium.translateEnabled = this.pointControls.translateEnabled;
      }
    },
    ...
    updateModelControls() {
      if (this.modelEditCesium) {
        ...
        this.modelEditCesium.translateEnabled = this.modelControls.translateEnabled;
    ...
    updateTilesControls() {
      if (this.tilesEditCesium) {
        ...
        this.tilesEditCesium.translateEnabled = this.tilesControls.translateEnabled;
      }
    },
